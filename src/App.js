    ...
    <>
      ...
      >
        <table>
          <tr>
            <td>
              <button onClick={prime} style={{ border: "solid 2px" }}>
                Check Prime
              </button>
              <button onClick={findFactors} style={{ border: "solid 2px" }}>
                Find Factor{" "}
              </button>
            </td>
          </tr>
          <tr>
            <td>
              <button onClick={perfectsqure} style={{ border: "solid 2px" }}>
                Check PerfectSquare
              </button>
              <button onClick={findsqure} style={{ border: "solid 2px" }}>
                Find Square
              </button>
            </td>
          </tr>
          <tr>
            <td>
              <button onClick={findCube} style={{ border: "solid 2px" }}>
                Find Cube
              </button>
              <button onClick={perfectCube} style={{ border: "solid 2px" }}>
                Check PerfectCube
              </button>
          ...
          <tr>
            <td>
              <button onClick={findFactorial} style={{ border: "solid 2px" }}>
                Find Factorial
              </button>
              <button onClick={primefactor} style={{ border: "solid 2px" }}>
